...
6. After Studio opens, tell the user to paste the Studio prompt or OpenCode config snippet back here if they want repo-local config help.
...
| User asks to set up MCP | Resolve project, ask confirmation, then call `supabase_open_mcp_setup` |
